...
export default function BeatArrangementView() {
  ...
  return (
    <div className="min-h-screen px-5 py-5">
      {/* <Card className="mb-6 flex flex-col items-center justify-center py-8 shadow-xl rounded-xl"> */}
      <h1 className="text-3xl md:text-4xl font-bold text-white mb-2 font-domine text-center tracking-tight">
        Music Portfolio
      </h1>
      {/* <p className="text-lg text-white/80 font-medium text-center max-w-xl">
          Listen to my original beats, preview waveforms, and find them on
          ...
          >
              ...
              <div className="z-10 flex items-center gap-1">
                {beat.spotifyUrl && (
                  <a
                    ...
                    className={`p-2 rounded-full z-10 focus:outline-none transition-colors duration-150 bg-on-surface/50 hover:bg-on-surface`}
                  >
                    <span className="flex">
                      <SiSpotify className="w-4 h-4 text-white" />
                    </span>
                  </a>
                )}
                {beat.appleMusicUrl && (
                  ...
                  >
                    <span className="flex">
                      <SiApplemusic className="w-4 h-4 text-white" />
                    </span>
                  </a>
                )}
              </div>
            ...
            <div className="flex-1 px-4 relative">
              <div
                ...
                className="w-full max-w-[15vw] h-10 mx-auto"
              />
            </div>
