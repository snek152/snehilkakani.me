  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="flex items-center justify-between gap-2 px-2 lg:px-4 py-1 lg:py-2 bg-secondary/70 backdrop-blur-xs shadow-lg absolute top-2 right-2 z-30 text-primary border-2 border-primary/5 rounded-2xl"
      >
        {project.github && (
          <motion.a
