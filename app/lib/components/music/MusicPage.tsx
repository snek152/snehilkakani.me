...
export default function MusicPage() {
  ...
  return (
    <div className="px-6 pb-12 pt-6 sm:px-8 lg:px-12 lg:pt-6">
      ...
      <section aria-labelledby="music-filter-heading" className="mt-2">
        ...
        <div className="flex flex-wrap gap-x-5 gap-y-2">
          {FILTERS.map((category) => {
            ...
            const label =
              category === "all" ? "All beats" : `Filter by ${category}`;
            return (
              <button
                key={category}
                type="button"
                ...
                className={`relative inline-flex min-h-8 items-center font-sans text-[length:var(--text-meta)] transition-[color,scale,opacity] duration-[120ms] ease-[var(--ease-press)] active:scale-95 active:opacity-70 ${
